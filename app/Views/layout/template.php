...
<head>
    ...
    <style>
        /* =========================================
           ...
           ========================================= */
        body { 
            background-color: #F4F7F7; /* Abu-abu kebiruan sangat terang agar konten mudah dibaca */
            font-family: 'Poppins', sans-serif; 
            overflow: hidden; 
            color: #2c3e3e; /* Teks gelap */
        }
        ...
        /* =========================================
           ...
           ========================================= */
        .btn-primary {
            background-color: #249E94 !important; /* Teal sedang */
            border-color: #249E94 !important;
            color: #fff !important;
            font-weight: 500;
        }
        .btn-primary:hover {
            background-color: #0C7779 !important; /* Teal lebih gelap saat di-hover */
            border-color: #0C7779 !important;
        }

        .btn-warning {
            background-color: #249E94 !important; /* Warna Edit */
            border-color: #249E94 !important;
            color: #fff !important;
        }
        .btn-warning:hover {
        ...
        .btn-danger {
            background-color: #005461 !important; /* Warna Hapus */
        ...
        #sidebar .sidebar-header .text-warning {
            color: #3BC1A8 !important; /* Mint/Hijau terang sebagai aksen yang nyala */
        }
...
#sidebar ul li a { 
        ...
        #sidebar ul:last-child { border-top: 1px solid #0C7779 !important; }
        ...
        .top-navbar { 
            ...
            min-height: 70px !important;
            max-height: 70px !important;
            background: #ffffff; /* Navbar tetap putih agar bersih */
            padding: 0 25px; 
