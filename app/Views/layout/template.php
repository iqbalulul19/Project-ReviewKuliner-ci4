                ...
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <?php if (session()->get('logged_in')) : ?>
                        ...
                        <?php if (session()->get('role') === 'admin') : ?>
                            <li class="nav-item mx-lg-1 my-2 my-lg-0 align-self-center">
                                <a class="btn btn-info fw-bold rounded-pill px-3 shadow-sm text-white" href="/admin/categories">
                                    ⚙️ Kelola Kategori
                                </a>
                            </li>

                            <li class="nav-item mx-lg-1 my-2 my-lg-0 align-self-center">
                                <a class="btn btn-info fw-bold rounded-pill px-3 shadow-sm text-white" href="/admin/tags">
                                    🏷️ Kelola Tag
                                </a>
                            </li>
                        <?php endif; ?>
