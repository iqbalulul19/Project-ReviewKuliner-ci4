...
<style>
    /* Pengaturan Tinggi Peta yang Responsif */
    #map {
        height: 450px;
    }
    ...
    @media (max-width: 768px) {
        #map {
            height: 300px;
            /* Di HP tingginya mengecil jadi 300px */
        }

        .header-banner {
            padding: 2rem 1rem !important;
            /* Kurangi padding banner atas di HP */
        }
    ...
    .horizontal-scroll {
        ...
        /* Efek magnet saat digeser */
    }

    .horizontal-scroll::-webkit-scrollbar {
        display: none;
        /* Khusus Chrome/Safari/Edge */
    }
    ...
    .card-item {
        flex: 0 0 auto;
        width: 85%;
        /* Lebar di HP (sisakan sedikit agar user tahu bisa digeser) */
        max-width: 350px;
        /* Lebar maksimal di Laptop */
        scroll-snap-align: start;
        /* Titik henti efek magnet */
    }
...
<script>
    ...
    dataTempat.forEach(function(place) {
        ...
        if (place.latitude && place.longitude) {
            ...
            // Susun Konten Pop-up saat Pin di-klik
            var popupContent = `
