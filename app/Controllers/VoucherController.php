...
class VoucherController extends BaseController
{
    public function index()
    {
        ...
        $uvModel      = new \App\Models\UserVoucherModel(); // Model transaksi

        $vouchers = $voucherModel->findAll();

        // Tambahkan data 'terjual' ke setiap voucher
    ...
    {
        $model = new VoucherModel();
        $data['voucher'] = $model->find($id);
        $data['places']  = (new \App\Models\PlaceModel())->findAll();
