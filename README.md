...
``` bash
git clone [https://github.com/iqbalulul19/project-reviewkuliner-ci4.git](https://github.com/iqbalulul19/project-reviewkuliner-ci4.git)
...
Copy file env yang ada di luar folder menjadi .env.

Buka file .env di teks editor, hapus tanda # pada CI_ENVIRONMENT dan ubah modenya menjadi development
